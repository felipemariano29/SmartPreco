...
import type { PriceDto, PricesDto } from "../smartPreçoAPI.schemas";

export const getCreatePriceResponseMock = (
  overrideResponse: Partial<PriceDto> = {},
): PriceDto => ({
...
export const getCreatePriceMockHandler = (
  overrideResponse?:
    ...
    | ((
      ...
      ) => Promise<PriceDto> | PriceDto),
) => {
  return http.post("*/prices", async (info) => {
    await delay(1000);
...
export const getReadPricesMockHandler = (
  overrideResponse?:
    | PricesDto
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0],
      ) => Promise<PricesDto> | PricesDto),
) => {
  return http.get("*/prices", async (info) => {
    await delay(1000);
