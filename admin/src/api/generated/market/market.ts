 ...
 */
export const readMarket = (marketId: string, signal?: AbortSignal) => {
  return axiosInstance<MarketDto>({
 ...
 */
export const deleteMarket = (marketId: string) => {
  return axiosInstance<void>({ url: `/markets/${marketId}`, method: "DELETE" });
};
